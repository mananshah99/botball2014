...
int main()	
{
	...
	*/
	...
	printf("Blue hanger commencing. Important note: Chad Labuda is weird\n");
...
/** WARNING:	TESTING CODES	TESTING CODES	TESTING CODES	TESTING CODES **/
/** DONT RUN IN TOURNAMENT UNLESS YOU ARE BEING DUMB**/
...
//TESTING BLUE HANGER # 1, NO TIME SO NOT DOING FOR REGIONALS
